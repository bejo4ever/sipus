...
import edu.ou.kmi.buddyspace.utils.History;
...
import org.jabber.jabberbeans.Extension.OOBBuilder;
import org.jabber.jabberbeans.Extension.XDelay;
import org.jabber.jabberbeans.Message;
import org.jabber.jabberbeans.MessageBuilder;
import org.jabber.jabberbeans.MessengerBean;
...
public class BSMessengerBean implements PacketListener {
     ...
     */
    public BSMessengerBean(ConnectionBean connection) {
        this();
